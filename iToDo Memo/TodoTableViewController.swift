...
class TodoTableViewController: UITableViewController {
    ...
    var office = ["todo1", "todo2", "todo3", "todo4"]
    ...
    @IBAction func addClickedTodo(id:UIBarButtonItem){
        
        var VC1 = self.storyboard!.instantiateViewControllerWithIdentifier("AddTodoViewController") as! AddTodoViewController
